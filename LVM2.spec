...
Source0  : https://mirrors.kernel.org/sourceware/lvm2/releases/LVM2.2.03.17.tgz
...
BuildRequires : pkgconfig(libdlmcontrol)
...
%prep
%setup -q -n LVM2.2.03.17
cd %{_builddir}/LVM2.2.03.17
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668104002
