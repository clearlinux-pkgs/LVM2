...
Version  : 2.03.18
Release  : 113
URL      : https://mirrors.kernel.org/sourceware/lvm2/releases/LVM2.2.03.18.tgz
Source0  : https://mirrors.kernel.org/sourceware/lvm2/releases/LVM2.2.03.18.tgz
...
%prep
%setup -q -n LVM2.2.03.18
cd %{_builddir}/LVM2.2.03.18
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672159106
