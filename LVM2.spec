...
Requires: LVM2-services = %{version}-%{release}
...
%package services
Summary: services components for the LVM2 package.
Group: Systemd services
Requires: systemd

%description services
services components for the LVM2 package.


%prep
%setup -q -n LVM2.2.03.25
cd %{_builddir}/LVM2.2.03.25
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a LVM2.2.03.25 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721234270
