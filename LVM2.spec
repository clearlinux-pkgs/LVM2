...
Source0  : https://mirrors.kernel.org/sourceware/lvm2/releases/LVM2.2.03.24.tgz
...
%prep
%setup -q -n LVM2.2.03.24
cd %{_builddir}/LVM2.2.03.24
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a LVM2.2.03.24 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719944974
