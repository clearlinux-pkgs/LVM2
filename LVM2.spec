...
Source0  : http://mirrors.kernel.org/sourceware/lvm2/releases/LVM2.2.02.130.tgz
...
%defattr(-,root,root,-)
/usr/lib64/*.so.*
/usr/lib64/device-mapper/libdevmapper-event-lvm2.so.2.02
